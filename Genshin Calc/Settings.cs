...
namespace Genshin_Calc
{
    ...
    public partial class Settings : Form
    {
        ...
        private string BoxReading(XmlElement Element)
        {
            switch (Element.Name)
            {
                case "ATK1":    return ATK1_MAX.Text;
                case "ATK2":    return ATK2_MAX.Text;
                case "Crit":    return Crit_MAX.Text;
                case "ElemBuff":return ElemBuff_MAX.Text;
                case "Skill":   return Skill_MAX.Text;
                case "RESM":    return RESM_MAX.Text;
                case "RESX":    return RESX_MAX.Text;
                case "EM":      return EM_MAX.Text;
                case "Reaction":return Reaction_MAX.Text;
                case "Other":   return Other_MAX.Text;
                default: return null;
            }
        }
